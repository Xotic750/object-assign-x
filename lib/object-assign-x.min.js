 ...
 */
"use strict";var $assign,objectKeys=_dereq_("object-keys-x"),isFunction=_dereq_("is-function-x"),reduce=_dereq_("array-reduce-x"),nativeAssign=isFunction(Object.assign)&&Object.assign,workingNativeAssign=function _nativeWorks(){try{var obj={};if(nativeAssign(obj,{0:1},{1:2})!==obj||2!==objectKeys(obj).length||1!==obj[0]||2!==obj[1])return!1}catch(ignore){return!1}return!0},lacksProperEnumerationOrder=function _enumOrder(){if(isFunction(Object.getOwnPropertyNames))try{var test1=Object("abc");if(test1[5]="de","5"===Object.getOwnPropertyNames(test1)[0])return!0;var test2=reduce("0123456789".split(""),function(acc,ignore,index){return acc["_"+String.fromCharCode(index)]=index,acc},{}),names=Object.getOwnPropertyNames(test2);if("0123456789"!==reduce(names,function(acc,name){return acc+test2[name]},""))return!0}catch(ignore){}var test3=reduce("abcdefghijklmnopqrst".split(""),function(acc,letter){return acc[letter]=letter,acc},{});return"abcdefghijklmnopqrst"!==objectKeys(Object.assign({},test3)).join("")},assignHasPendingExceptions=function _exceptions(){if(!1===isFunction(Object.preventExtensions))return!1;var thrower;try{thrower=Object.preventExtensions({1:2})}catch(ignore){return!1}try{Object.assign(thrower,"xy")}catch(ignore){return"y"===thrower[1]}return!1};if(!1===nativeAssign||(!1===workingNativeAssign()||(!!lacksProperEnumerationOrder()||!!assignHasPendingExceptions()))){var isEnumerable,toObject=_dereq_("to-object-x"),slice=_dereq_("array-slice-x"),filter=_dereq_("array-filter-x"),isArray=_dereq_("is-array-x"),isNil=_dereq_("is-nil-x"),getOPS=isFunction(Object.getOwnPropertySymbols)&&Object.getOwnPropertySymbols,hasWorkingGOPS=function(){try{if(isArray(Object.getOwnPropertySymbols({})))return isEnumerable=Object.prototype.propertyIsEnumerable,!0}catch(ignore){}return!1}(),assignTo=function _assignTo(source){return function assignToSource(target,key){return target[key]=source[key],target}},assignReducer=function _assignReducer(target,source){if(isNil(source))return target;var object=Object(source),sourceKeys=objectKeys(object);if(hasWorkingGOPS){var symbols=filter(getOPS(object),function _filter(symbol){return isEnumerable.call(object,symbol)});sourceKeys=sourceKeys.concat(symbols)}return reduce(sourceKeys,assignTo(object),target)};$assign=function assign(target){var to=toObject(target);return reduce(slice(arguments,1),assignReducer,to)}}else $assign=nativeAssign;module.exports=$assign},{"array-filter-x":2,"array-reduce-x":3,"array-slice-x":4,"is-array-x":13,"is-function-x":15,"is-nil-x":20,"object-keys-x":28,"to-object-x":36}],2:[function(_dereq_,module,exports){/**
 ...
 * @module is-array-x
 */
"use strict";var $isArray=Array.isArray;try{if(!1===$isArray([])||$isArray({length:0}))throw new Error("failed")}catch(ignore){var toStringTag=_dereq_("to-string-tag-x");$isArray=function isArray(obj){return"[object Array]"===toStringTag(obj)}}module.exports=$isArray},{"to-string-tag-x":37}],14:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var trim=_dereq_("trim-x"),reNormalize=new RegExp("["+_dereq_("white-space-x").string+"]+","g");module.exports=function normalizeSpace(string){return trim(string).replace(reNormalize," ")}},{"trim-x":41,"white-space-x":43}],28:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isString=_dereq_("is-string"),STRIP_COMMENTS=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm;module.exports=function replaceComments(string){var replacement=arguments.length>1&&isString(arguments[1])?arguments[1]:"";return isString(string)?string.replace(STRIP_COMMENTS,replacement):""}},{"is-string":22}],32:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNil=_dereq_("is-nil-x");module.exports=function RequireObjectCoercible(value){if(isNil(value))throw new TypeError("Cannot call method on "+value);return value}},{"is-nil-x":20}],33:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isSymbol=_dereq_("is-symbol"),pToString=_dereq_("has-symbol-support-x")&&Symbol.prototype.toString;module.exports=function safeToString(value){return pToString&&isSymbol(value)?pToString.call(value):String(value)}},{"has-symbol-support-x":10,"is-symbol":23}],34:[function(_dereq_,module,exports){/**
 ...
 * @module to-integer-x
 */
"use strict";var $isNaN=_dereq_("is-nan"),$isFinite=_dereq_("is-finite-x"),$sign=_dereq_("math-sign-x");module.exports=function ToInteger(value){var number=Number(value);return $isNaN(number)?0:0===number||!1===$isFinite(number)?number:$sign(number)*Math.floor(Math.abs(number))}},{"is-finite-x":14,"is-nan":17,"math-sign-x":25}],35:[function(_dereq_,module,exports){/**
 ...
 * @module to-object-x
 */
"use strict";var $requireObjectCoercible=_dereq_("require-object-coercible-x");module.exports=function ToObject(value){return Object($requireObjectCoercible(value))}},{"require-object-coercible-x":32}],37:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return String(value)}},{"is-symbol":23}],39:[function(_dereq_,module,exports){/**
