 ...
 */
"use strict";var $assign,attempt=_dereq_("attempt-x"),objectKeys=_dereq_("object-keys-x"),isFunction=_dereq_("is-function-x"),reduce=_dereq_("array-reduce-x"),getOwnPropertyNames=_dereq_("get-own-property-names-x"),isObjectLike=_dereq_("is-object-like-x"),nativeAssign=isFunction(Object.assign)&&Object.assign,workingNativeAssign=function _nativeWorks(){var obj={},res=attempt(nativeAssign,obj,{0:1},{1:2});return!1===res.threw&&res.value===obj&&2===objectKeys(obj).length&&1===obj[0]&&2===obj[1]},lacksProperEnumerationOrder=function _enumOrder(){var test1=Object("abc");if(test1[5]="de","5"===getOwnPropertyNames(test1)[0])return!0;var test2=reduce("0123456789".split(""),function(acc,ignore,index){return acc["_"+String.fromCharCode(index)]=index,acc},{});if("0123456789"!==reduce(getOwnPropertyNames(test2),function(acc,name){return acc+test2[name]},""))return!0;var test3=reduce("abcdefghijklmnopqrst".split(""),function(acc,letter){return acc[letter]=letter,acc},{}),result=attempt(nativeAssign,{},test3);return!1===result.threw&&"abcdefghijklmnopqrst"!==objectKeys(result.value).join("")},assignHasPendingExceptions=function _exceptions(){if(!1===isFunction(Object.preventExtensions))return!1;var result=attempt(Object.preventExtensions,{1:2});if(result.threw||!1===isObjectLike(result.value))return!1;var thrower=result.value;return!!(result=attempt(nativeAssign,thrower,"xy")).threw&&"y"===thrower[1]};if(!1===nativeAssign||(!1===workingNativeAssign()||(!!lacksProperEnumerationOrder()||!!assignHasPendingExceptions()))){var toObject=_dereq_("to-object-x"),slice=_dereq_("array-slice-x"),isNil=_dereq_("is-nil-x"),getOEPS=_dereq_("get-own-enumerable-property-symbols-x"),concat=Array.prototype.concat;$assign=function assign(target){return reduce(slice(arguments,1),function _assignSources(tgt,source){if(isNil(source))return tgt;var object=Object(source);return reduce(concat.call(objectKeys(object),getOEPS(object)),function _assignTo(tar,key){return tar[key]=object[key],tar},tgt)},toObject(target))}}else $assign=nativeAssign;module.exports=$assign},{"array-reduce-x":4,"array-slice-x":5,"attempt-x":8,"get-own-enumerable-property-symbols-x":9,"get-own-property-names-x":10,"is-function-x":21,"is-nil-x":24,"is-object-like-x":25,"object-keys-x":37,"to-object-x":48}],2:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isFunction=_dereq_("is-function-x"),safeToString=_dereq_("safe-to-string-x"),isPrimitive=_dereq_("is-primitive");module.exports=function assertIsFunction(callback){if(!1===isFunction(callback)){var msg=isPrimitive(callback)?safeToString(callback):"#<Object>";throw new TypeError(msg+" is not a function")}return callback}},{"is-function-x":21,"is-primitive":26,"safe-to-string-x":43}],7:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var safeToString=_dereq_("safe-to-string-x"),isPrimitive=_dereq_("is-primitive");module.exports=function assertIsObject(value){if(isPrimitive(value))throw new TypeError(safeToString(value)+" is not an object");return value}},{"is-primitive":26,"safe-to-string-x":43}],8:[function(_dereq_,module,exports){/**
 ...
 * @module attempt-x
 */
"use strict";var arrayLikeSlice=_dereq_("array-like-slice-x");module.exports=function attempt(fn){try{return{threw:!1,value:fn.apply(this,arrayLikeSlice(arguments,1))}}catch(e){return{threw:!0,value:e}}}},{"array-like-slice-x":3}],9:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var boxedString=Object("a");module.exports="a"===boxedString[0]&&0 in boxedString},{}],13:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var toObject=_dereq_("to-object-x"),toPropertyKey=_dereq_("to-property-key-x"),hop=Object.prototype.hasOwnProperty;module.exports=function hasOwnProperty(object,property){return hop.call(toObject(object),toPropertyKey(property))}},{"to-object-x":48,"to-property-key-x":50}],14:[function(_dereq_,module,exports){/**
 ...
 * @module is-falsey-x
 */
"use strict";module.exports=function isFalsey(value){return!1===Boolean(value)}},{}],20:[function(_dereq_,module,exports){/**
 ...
 * @module is-finite-x
 */
"use strict";var numberIsNaN=_dereq_("is-nan-x");module.exports=function isFinite(number){return"number"==typeof number&&!1===numberIsNaN(number)&&number!==1/0&&number!==-1/0}},{"is-nan-x":23}],21:[function(_dereq_,module,exports){/**
 ...
 * @module is-nil-x
 */
"use strict";var isUndefined=_dereq_("validate.io-undefined"),isNull=_dereq_("lodash.isnull");module.exports=function isNil(value){return isNull(value)||isUndefined(value)}},{"lodash.isnull":30,"validate.io-undefined":56}],25:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isFunction=_dereq_("is-function-x"),isPrimitive=_dereq_("is-primitive");module.exports=function isObjectLike(value){return!1===isPrimitive(value)&&!1===isFunction(value,!0)}},{"is-function-x":21,"is-primitive":26}],26:[function(_dereq_,module,exports){"use strict";module.exports=function isPrimitive(value){return null==value||"function"!=typeof value&&"object"!=typeof value}},{}],27:[function(_dereq_,module,exports){/**
 ...
 * @module math-sign-x
 */
"use strict";var toNumber=_dereq_("to-number-x"),numberIsNaN=_dereq_("is-nan-x");module.exports=function sign(x){var n=toNumber(x);return 0===n||numberIsNaN(n)?n:n>0?1:-1}},{"is-nan-x":23,"to-number-x":47}],33:[function(_dereq_,module,exports){"use strict";module.exports=9007199254740991},{}],34:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var trim=_dereq_("trim-x"),reNormalize=new RegExp("["+_dereq_("white-space-x").string+"]+","g");module.exports=function normalizeSpace(string){return trim(string).replace(reNormalize," ")}},{"trim-x":55,"white-space-x":57}],35:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isString=_dereq_("is-string"),STRIP_COMMENTS=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm;module.exports=function replaceComments(string){var replacement=arguments.length>1&&isString(arguments[1])?arguments[1]:"";return isString(string)?string.replace(STRIP_COMMENTS,replacement):""}},{"is-string":28}],42:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNil=_dereq_("is-nil-x");module.exports=function RequireObjectCoercible(value){if(isNil(value))throw new TypeError("Cannot call method on "+value);return value}},{"is-nil-x":24}],43:[function(_dereq_,module,exports){/**
 ...
 * @module to-length-x
 */
"use strict";var toInteger=_dereq_("to-integer-x"),MAX_SAFE_INTEGER=_dereq_("max-safe-integer");module.exports=function toLength(value){var len=toInteger(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len}},{"max-safe-integer":33,"to-integer-x":45}],47:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var hasSymbols=_dereq_("has-symbol-support-x"),toPrimitive=_dereq_("to-primitive-x"),toStr=_dereq_("to-string-x");module.exports=function toPropertyKey(argument){var key=toPrimitive(argument,String);return hasSymbols&&"symbol"==typeof key?key:toStr(key)}},{"has-symbol-support-x":14,"to-primitive-x":49,"to-string-x":52}],51:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr=Object.prototype.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":30,"validate.io-undefined":56}],52:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return String(value)}},{"is-symbol":29}],53:[function(_dereq_,module,exports){/**
