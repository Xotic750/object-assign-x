...
var object_assign_x_esm_implementation = function assign(target) {
  var outerIteratee = function outerIteratee(tgt, source) {
    ...
    return array_reduce_x_esm(concat(object_keys_x_esm(object), get_own_enumerable_property_symbols_x_esm(object)), innerIteratee, tgt);
  };
  /* eslint-disable-next-line prefer-rest-params */
